...
'image': 'https://img.icons8.com/external-others-cattaleeya-thongsriphong/2x/external-Avatar-male-avatar-color-line-others-cattaleeya-thongsriphong-2.png',
...
'bmValues': {'Rent': 3500.0,
 ...
 'Cash': 4000.0,
 'Investment': 10000.0}}
const bmData = [{'Date': '01/01/2022', 'category': 'Savings', 'value': 28}, {'Date': '01/01/2022', 'category': 'Top10% Savings', 'value': 60}, {'Date': '01/01/2022', 'category': 'Bottom-10% Savings', 'value': 80}, {'Date': '01/02/2022', 'category': 'Savings', 'value': 32}, {'Date': '01/02/2022', 'category': 'Top10% Savings', 'value': 58}, {'Date': '01/02/2022', 'category': 'Bottom-10% Savings', 'value': 78}, {'Date': '01/03/2022', 'category': 'Savings', 'value': 35}, {'Date': '01/03/2022', 'category': 'Top10% Savings', 'value': 59}, {'Date': '01/03/2022', 'category': 'Bottom-10% Savings', 'value': 90}, {'Date': '01/04/2022', 'category': 'Savings', 'value': 25}, {'Date': '01/04/2022', 'category': 'Top10% Savings', 'value': 58}, {'Date': '01/04/2022', 'category': 'Bottom-10% Savings', 'value': 82}, {'Date': '01/05/2022', 'category': 'Savings', 'value': 28}, {'Date': '01/05/2022', 'category': 'Top10% Savings', 'value': 57}, {'Date': '01/05/2022', 'category': 'Bottom-10% Savings', 'value': 75}, {'Date': '01/06/2022', 'category': 'Savings', 'value': 25}, {'Date': '01/06/2022', 'category': 'Top10% Savings', 'value': 60}, {'Date': '01/06/2022', 'category': 'Bottom-10% Savings', 'value': 80}, {'Date': '01/07/2022', 'category': 'Savings', 'value': 28}, {'Date': '01/07/2022', 'category': 'Top10% Savings', 'value': 61}, {'Date': '01/07/2022', 'category': 'Bottom-10% Savings', 'value': 78}, {'Date': '01/08/2022', 'category': 'Savings', 'value': 30}, {'Date': '01/08/2022', 'category': 'Top10% Savings', 'value': 58}, {'Date': '01/08/2022', 'category': 'Bottom-10% Savings', 'value': 79}, {'Date': '01/09/2022', 'category': 'Savings', 'value': 31}, {'Date': '01/09/2022', 'category': 'Top10% Savings', 'value': 58}, {'Date': '01/09/2022', 'category': 'Bottom-10% Savings', 'value': 77}]
const DemoLine = (data) => {
...
function App() {
  ...
  return (
    <div className="App">
      ...
      <div className="ButtonLB"><div className="ButtonLBText">Go to LeaderBoard</div></div>
      </div>
 ...
 <div className="allAnalysis">
  ...
  <div className="blContent">
    {/* <div className="blContentL">{DemoPieExpense([{
                                                  ...
                                                  {/* <div className="blContetnL">{DemoColumn(['Rent','Groceries','Utilities','Fashion','Others'].map((d)=>{return { name: "Expense", value: userDict.userValues[d] ,type:d}}).concat(
    ['Rent','Groceries','Utilities','Fashion','Others'].map((d)=>{return { name: "Benchmark", value: userDict.bmValues[d], type:d }})
    ))}</div> */}
    <div className='blContetnL'>{DemoRadar(['Rent','Groceries','Utilities','Fashion','Others'].map((d)=>{return { name: "Expense", value: userDict.userValues[d] ,type:d}}).concat(
    ['Rent','Groceries','Utilities','Fashion','Others'].map((d)=>{return { name: "Benchmark", value: userDict.bmValues[d], type:d }})
    ))}</div>
    <div className="blContentR"><div><span className="bmDescription">You are expenses are <span className="bmleveltext">more than </span>the average spend in your income category. See drill-down below</span></div>
  ...
  <div className="brContent">
    <div className='brContentL'>{DemoColumn(['Cash','Investment'].map((d)=>{return { name: "Savings", value: userDict.userValues[d] ,type:d}}).concat(
    ['Cash','Investment'].map((d)=>{return { name: "Benchmark", value: userDict.bmValues[d], type:d }})
    ))}</div>
    <div className='brContentR'>
    <span className="bmDescription">You are investments are <span className="bmleveltext">less than </span>the average investments in your income category.</span>
